...
//
//     final jikan = jikanFromJson(jsonString);

import 'dart:convert';

Jikan jikanFromJson(String str) => Jikan.fromJson(json.decode(str));

String jikanToJson(Jikan data) => json.encode(data.toJson());

class Jikan {
  Pagination? pagination;
  List<Datum>? data;

  Jikan({this.pagination, this.data});

  factory Jikan.fromJson(Map<String, dynamic> json) => Jikan(
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    images: Map.from(
      json["images"]!,
    ).map((k, v) => MapEntry<String, ImageModels>(k, ImageModels.fromJson(v))),
...
class ImageModels {
  ...
  ImageModels({this.imageUrl, this.smallImageUrl, this.largeImageUrl});
